...
description: 自动解析和评估 HR 招聘简历，适用于 PDF、Word、文本简历和岗位 JD。用于生成结构化候选人卡片、标准化岗位经历、正式工作/实习/项目分项工龄、销售岗证据强度评估、履历稳定性和 Gap 分、强推荐/待审核/暂不推荐分层、年龄工龄异常、时间重叠、低可信经历、频繁跳槽等异常校验。
---
...
3. **模块 C：异常校验引擎**，兜住年龄工龄、时间线、低可信经历、岗位跳跃、频繁跳槽、学历缺失等低级误判。
...
- **P0 拦截类**：年龄-工龄高异常、工龄开始早于 16 岁、同期多段全职、同期 3 段经历、时间倒置、近期极频繁跳槽。
- **P1 降权类**：低可信经历、全职和实习重叠、岗位跳跃、学历层级缺失、近期跳槽偏高。
- **P2 提示类**：时间缺失、项目重叠、学校缺失、跨职能变化、轻度频繁变动。
